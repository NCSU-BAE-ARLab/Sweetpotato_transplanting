...
def get_coco_from_labelme_folder_customized(
    ...
    for json_path in tqdm(labelme_json_list, "Converting labelme annotations to COCO format"):
        ...
        for i in range(total_annotations):
            ...
            shape = all_shapes[3*i]
            shape_keypoint1 = all_shapes[3*i+1]
            shape_keypoint2 = all_shapes[3*i+2]

            print(shape["shape_type"])
            print(shape_keypoint1["shape_type"])
            print(shape_keypoint2["shape_type"])
            # print(i,shape['shape_type'],shape_keypoint1['shape_type'],shape_keypoint2['shape_type'])
            ...
            keypoints = []
            if shape_keypoint1['label']=='Head' or shape_keypoint1['label']=='head':
                shape1 = shape_keypoint1
                shape2 = shape_keypoint2
            else:
                shape1 = shape_keypoint2
                shape2 = shape_keypoint1

            point1 = shape1['points'][0]
            point2 = shape2['points'][0]
            keypoints = [
            ...
            if shape["shape_type"] == "rectangle":
                ...
                coco_annotation = CocoAnnotation(
                    ...
                    category_name=category_name,
                    keypoints=keypoints,
                    num_keypoints=2  # Total number of keypoints
                )
            else:
