...
from labelme2coco.labelme2coco_v1_2kp import get_coco_from_labelme_folder,get_coco_from_labelme_folder_customized
...
def convert(
    ...
    """
    if use_customize_function:
        coco = get_coco_from_labelme_folder_customized(labelme_folder, skip_labels=skip_labels, category_id_start=category_id_start)
    else:
